...
func TestOpenAIAccountLoadPlan_DeprioritizesSlowTTFTAccountWithoutDisablingIt(t *testing.T) {
	...
	smallPlan := scheduler.buildOpenAIAccountLoadPlan(context.Background(), OpenAIAccountScheduleRequest{
	...
	largePlan := scheduler.buildOpenAIAccountLoadPlan(context.Background(), OpenAIAccountScheduleRequest{
		RequestedModel:   "gpt-5.1",
